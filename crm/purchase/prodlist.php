...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
  <tr>
    <td class="Big"><img src="template/default/content/images/notify_new.gif" align="absmiddle"><span class="big3"> 采购产品列表</span>
	<span style="font-size:12px; float:right; margin-right:20px;"><a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>"><<返回采购列表
	</a></span>    </td>
  </tr>
</table>
...
<?php foreach ($result as $row) {?>
	...
	<input type="checkbox" name="id[]" value="<?php echo $row['id']?>" class="checkbox" /></td>
      ...
      <td align="center" class="TableData"><a href="admin.php?ac=<?php echo $ac;?>&fileurl=<?php echo $fileurl;?>&do=add&pid=<?php echo $row['id']?>&prod=1">生成采购单</a></td>
    </tr>
    ...
    <tr align="center" class="TableControl">
      <td height="35" colspan="8" align="left" nowrap>
        <input type="checkbox" class="checkbox" value="1" name="chkall" onClick="check_all(this)" />全选&nbsp;&nbsp;
						  <a href="javascript:document:update.submit();"><img class="v-al-middle" src="template/default/images/newfolder.gif" />&nbsp;生成所选产品采购单</a>
