...
<td><?php echo get_human_db($row['id'],"toa_4_WORK_UNIT")?></td>
<td><?php echo get_human_db($row['id'],"toa_4_MOBILE")?></td>
<td><?php echo get_human_db($row['id'],"toa_4_POST_OF_JOB")?></td>
<td><?php echo get_human_db($row['id'],"toa_4_WITNESS")?></td>
