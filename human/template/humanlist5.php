...
<td><?php echo get_human_db($row['id'],"toa_5_ABILITY_NAME")?></td>
<td><?php echo get_human_db($row['id'],"toa_5_SKILLS_LEVEL")?></td>
<td><?php echo get_human_db($row['id'],"toa_5_ISSUE_DATE")?></td>
<td><?php echo get_human_db($row['id'],"toa_5_EXPIRES")?></td>
