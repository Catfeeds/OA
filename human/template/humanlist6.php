...
<table  class="table table-bordered table-hover" width="100%">
      ...
      <td width="100">流水号</td>
								<td width="120">单位员工</td>
									<td width="120">成员姓名</td>
									<td width="120">与本人关系</td>
									<td width="120">职业</td>
									<td width="120">担任职务</td>
...
<td><?php echo get_human_db($row['id'],"toa_6_MEMBER")?></td>
<td><?php echo get_human_db($row['id'],"toa_6_ELATIONSHIP")?></td>
<td><?php echo get_human_db($row['id'],"toa_6_JOB_OCCUPATION")?></td>
<td><?php echo get_human_db($row['id'],"toa_6_POST_OF_JOB")?></td>
