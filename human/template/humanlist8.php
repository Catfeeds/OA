...
<td><?php echo get_human_db($row['id'],"toa_8_REAPPOINTMENT_TYPE")?></td>
<td><?php echo get_human_db($row['id'],"toa_8_APPLICATION_DATE")?></td>
<td><?php echo get_human_db($row['id'],"toa_8_NOW_POSITION")?></td>
<td><?php echo get_human_db($row['id'],"toa_8_REAPPOINTMENT_DEPT")?></td>
