...
<td><?php echo get_human_db($row['id'],"toa_10_CARE_TYPE")?></td>
<td><?php echo get_human_db($row['id'],"toa_10_CARE_FEES")?></td>
<td><?php echo get_human_db($row['id'],"toa_10_CARE_DATE")?></td>
