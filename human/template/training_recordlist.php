...
<div class="tabbable work-nav"> <!-- Only required for left/right tabs -->
				<ul id="myTab" class="nav nav-tabs">
					<li class="active"><a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&id=<?php echo $id?>" data-toggle="tab">培训记录信息列表</a></li>
					<li><a href="admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>" data-toggle="tab">培训信息列表</a></li>
...
<div class="search_area">
	...
	<input type="hidden" name="ac" value="<?php echo $ac?>" />
        ...
        <div class="form-search form-search-top" style="text-align:left;padding-left:10px;">
	        ...
	        <div class="adv-select-label">受训人员：</div>
       		<input type="text"  name="user" size="20" class="span1" value="<?php echo urldecode($user)?>">  
			<div class="adv-select-label">培训费用：</div>
       		<input type="text"  name="price" size="20" class="span1" value="<?php echo urldecode($price)?>">  
			<div class="adv-select-label">培训机构：</div>
       		<input type="text"  name="organization" size="20" class="span1" value="<?php echo urldecode($organization)?>">  
...
<div class="data-wrap">
	<div class="data-operation">
		...
		<button type="button" action="new_work" class="btn btn-success" onClick="javascript:window.location='admin.php?ac=<?php echo $ac?>&fileurl=<?php echo $fileurl?>&do=add&rid=<?php echo $id?>'">发布信息</button>				
