...
<td><?php echo get_human_db($row['id'],"toa_9_APPROVE_PERSON_NAME")?></td>
<td><?php echo get_human_db($row['id'],"toa_9_POST_NAME")?></td>
<td><?php echo get_human_db($row['id'],"toa_9_GET_METHOD")?></td>
<td><?php echo get_human_db($row['id'],"toa_9_RECEIVE_TIME")?></td>
