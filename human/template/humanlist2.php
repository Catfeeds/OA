...
<table  class="table table-bordered table-hover" width="100%">
      ...
      <td width="100">流水号</td>
								<td width="120">单位员工</td>
									<td width="120">证照类型</td>
									<td width="120">证照编号</td>
									<td width="120">证照名称</td>
									<td width="120">状态</td>
...
<td><?php echo get_human_db($row['id'],"toa_2_LICENSE_TYPE")?></td>
<td><?php echo get_human_db($row['id'],"toa_2_LICENSE_NO")?></td>
<td><?php echo get_human_db($row['id'],"toa_2_LICENSE_NAME")?></td>
<td><?php echo get_human_db($row['id'],"toa_2_STATUS")?></td>
